...
8. :sparkles: **ArgueTutor: An Adaptive Dialog-Based Learning System for Argumentation Skills**
...
9. :sparkles: **Empowering Personalized Learning through a Conversation-based Tutoring System with Student Modeling**

    *Minju Park, Sojung Kim, Seunghyun Lee, Soonwoo Kwon, Kyuseok Kim*

    CHI-LBW, 2024. [`workshop`](https://arxiv.org/abs/2403.14071)

10. **An Educational Tool for Learning about Social Media Tracking, Profiling, and Recommendation**
...
11. :sparkles: **AutoTutor meets Large Language Models: A Language Model Tutor with Rich Pedagogy and Guardrails**

    *Sankalan Pal Chowdhury, Vilém Zouhar, Mrinmaya Sachan*

    Learning@Scale, 2024. [`conference`](https://arxiv.org/abs/2402.09216)

12. :sparkles: **Personality-aware Student Simulation for Conversational Intelligent Tutoring Systems**

    *Zhengyuan Liu, Stella Xin Yin, Geyu Lin, Nancy F. Chen*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2404.06762)

13. :sparkles: **Intelligent Tutor: Leveraging ChatGPT and Microsoft Copilot Studio to Deliver a Generative AI Student Support and Feedback System within Teams**

    *Wei-Yu Chen*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2404.06762)

14. :sparkles: **EduAgent: Generative Student Agents in Learning**

    *Songlin Xu, Xinyu Zhang, Lianhui Qin*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2404.07963)

15. :sparkles: **Scaffolding Language Learning via Multi-modal Tutoring Systems with Pedagogical Instructions**

    *Zhengyuan Liu, Stella Xin Yin, Carolyn Lee, Nancy F. Chen*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2404.03429)

16. :sparkles: **Apprentice Tutor Builder: A Platform For Users to Create and Personalize Intelligent Tutors**

    *Glen Smith, Adit Gupta, Christopher MacLellan*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2404.07883)

17. **OATutor: An Open-source Adaptive Tutoring System and Curated Content Library for Learning Sciences Research**
...
18. :sparkles: **AI-TA: Towards an Intelligent Question-Answer Teaching Assistant using Open-Source LLMs**
...
19. :sparkles: **WordPlay: An Agent Framework for Language Learning Games**
...
20. :sparkles: **Empowering Private Tutoring by Chaining Large Language Models**

    *Yulin Chen, Ning Ding, Hai-Tao Zheng, Zhiyuan Liu, Maosong Sun, Bowen Zhou*

    arXiv, 2023. [`preprint`](https://arxiv.org/abs/2309.08112)

21. :sparkles: **How to Build an AI Tutor that Can Adapt to Any Course and Provide Accurate Answers Using Large Language Model and Retrieval-Augmented Generation**

    *Chenxi Dong*

    arXiv, 2023. [`preprint`](https://arxiv.org/abs/2311.17696)

22. **Personal Knowledge Graphs: Use Cases in e-learning Platforms**

    *Eleni Ilkou*

    WWW Companion, 2022. [`workshop`](https://arxiv.org/abs/2203.08507)

23. **An Interaction Design for Machine Teaching to Develop AI Tutors**

    *Daniel Weitekamp, Erik Harpstead, K. Koedinger*

    CHI, 2020. [`conference`](https://dl.acm.org/doi/10.1145/3313831.3376226)

24. **The Cognitive Tutor Authoring Tools (CTAT): Preliminary Evaluation of Efficiency Gains**
...
25. **Locus of Feedback Control in Computer-Based Tutoring**
...
26. **Course Recommender Systems Need to Consider the Job Market**

    *Jibril Frej, Anna Dai, Syrielle Montariol, Antoine Bosselut, Tanja Käser*

    SIGIR, 2024. [`conference`](https://arxiv.org/abs/2404.10876)

27. :sparkles: **Learning Structure and Knowledge Aware Representation with Large Language Models for Concept Recommendation**
...
28. **Set-to-Sequence Ranking-based Concept-aware Learning Path Recommendation**
...
29. **Graph Enhanced Hierarchical Reinforcement Learning for Goal-oriented Learning Path Recommendation**
...
30. **MHRR: MOOCs Recommender Service With Meta Hierarchical Reinforced Ranking**
...
36. **Combining Adaptivity with Progression Ordering for Intelligent Tutoring Systems**
...
37. **The Effects of Adaptive Learning in a Massive Open Online Course on Learners’ Skill Development**
...
38. **Program2Tutor: Combining Automatic Curriculum Generation with Multi-Armed Bandits for Intelligent Tutoring Systems**
...
39. **Towards Modeling Learner Performance with Large Language Models**
...
40. :sparkles: **FOKE: A Personalized and Explainable Education Framework Integrating Foundation Models, Knowledge Graphs, and Prompt Engineering**

    *Silan Hu, Xiaoning Wang*

    preprint, 2024. [`conference`](https://arxiv.org/abs/2405.03734)

41. **Visualizing Self-Regulated Learner Profiles in Dashboards: Design Insights from Teachers**
...
42. :sparkles: **Contextualizing Problems to Student Interests at Scale in Intelligent Tutoring System Using Large Language Models**
...
43. **Mitigating Biases in Student Performance Prediction via Attention-Based Personalized Federated Learning**
...
44. **Search-Efficient Computerized Adaptive Testing**
...
45. **GMOCAT: A Graph-Enhanced Multi-Objective Method for Computerized Adaptive Testing**
...
46. **A Bounded Ability Estimation for Computerized Adaptive Testing**
...
47. **Fully Adaptive Framework: Neural Computerized Adaptive Testing for Online Education**
...
48. **A Robust Computerized Adaptive Testing Approach in Educational Question Retrieval**
...
49. **BOBCAT: Bilevel Optimization-Based Computerized Adaptive Testing**
...
50. **Zero-1-to-3: Domain-level Zero-shot Cognitive Diagnosis via One Batch of Early-bird Students towards Three Diagnostic Objectives**
...
51. **Symbolic Cognitive Diagnosis via Hybrid Optimization for Intelligent Education Systems**

    *Junhao Shen, Hong Qian, Wei Zhang, Aimin Zhou*

    AAAI, 2024. [`conference`](https://arxiv.org/abs/2401.10840)

52. **Path-Specific Causal Reasoning for Fairness-aware Cognitive Diagnosis**

    *Dacao Zhang, Kun Zhang, Le Wu, Mi Tian, Richang Hong, Meng Wang*

    KDD, 2024. [`conference`](https://arxiv.org/abs/2406.03064)

53. **Capturing Homogeneous Influence among Students: Hypergraph Cognitive Diagnosis for Intelligent Education Systems**

    *Junhao Shen, Hong Qian, Shuo Liu, Wei Zhang, Bo Jiang, Aimin Zhou*

    KDD, 2024. [`conference`](nan)

54. :sparkles: **Generative Students: Using LLM-Simulated Student Profiles to Support Question Item Evaluation**

    *Xinyi Lu, Xu Wang*

    Learning@Scale, 2024. [`conference`](https://arxiv.org/abs/2405.11591)

55. **Multivariate Cognitive Response Framework for Student Performance Prediction on MOOC**

    *Lianhong Wang, Xiaoyao Li, Zhihui Luo, Zinan Hu, Qing Yan*

    TKDE, 2024. [`journal`](https://ieeexplore.ieee.org/document/10210482)

56. **Inductive Cognitive Diagnosis for Fast Student Learning in Web-Based Online Intelligent Education Systems**

    *Shuo Liu, Junhao Shen, Hong Qian, Aimin Zhou*

    WWW, 2024. [`conference`](https://arxiv.org/abs/2404.11290)

57. **Endowing Interpretability for Neural Cognitive Diagnosis by Efficient Kolmogorov-Arnold Networks**
...
58. **Disentangling Cognitive Diagnosis with Limited Exercise Labels**
...
59. **Leveraging Transferable Knowledge Concept Graph Embedding for Cold-Start Cognitive Diagnosis**
...
60. **Reconciling Cognitive Modeling with Knowledge Forgetting: A Continuous Time-aware Neural Network Approach**
...
61. **HierCDF: A Bayesian Network-based Hierarchical Cognitive Diagnosis Framework**
...
65. **Incremental Cognitive Diagnosis for Intelligent Education**
...
66. **Neural Cognitive Diagnosis for Intelligent Education Systems**
...
67. **Interpretable Knowledge Tracing with Multiscale State Representation**
...
68. **Language Model Can Do Knowledge Tracing: Simple but Effective Method to Integrate Language Model and Knowledge Tracing Task**

    *Shangshang Yang, Linrui Qin, Xiaoshan Yu*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2406.02893)

69. **Enhancing Deep Knowledge Tracing via Diffusion Models for Personalized Adaptive Learning**
...
70. **Deep Attentive Model for Knowledge Tracing**

    *Xin-Peng Wang, Liang Chen, M. Zhang*

    AAAI, 2023. [`conference`](https://ojs.aaai.org/index.php/AAAI/article/view/26214)

71. **Evolutionary Neural Architecture Search for Transformer in Knowledge Tracing**
...
72. **Monitoring Student Progress for Learning Process-Consistent Knowledge Tracing**
...
73. **Tracing Knowledge Instead of Patterns: Stable Knowledge Tracing with Diagnostic Transformer**
...
74. **Interpretable Knowledge Tracing: Simple and Efficient Student Modeling with Causal Relations**
...
75. **No Task Left Behind: Multi-Task Learning of Knowledge Tracing and Option Tracing for Better Student Assessment**

    *Suyeong An, Junghoon Kim, Minsam Kim, Juneyoung Park*

    AAAI, 2022. [`conference`](https://arxiv.org/abs/2204.14006)

76. **HGKT: Introducing Hierarchical Exercise Graph for Knowledge Tracing**

    *Hanshuang Tong, Zhen Wang, Yun Zhou, Shiwei Tong, Wenyuan Han, Qi Liu*

    SIGIR, 2022. [`conference`](https://arxiv.org/abs/2006.16915)

77. **Learning Process-consistent Knowledge Tracing**
...
78. **Improving Knowledge Tracing via Pre-training Question Embeddings**

    *Yunfei Liu, Yang Yang, Xianyu Chen, Jian Shen, Haifeng Zhang, Yong Yu*

    IJCAI, 2020. [`conference`](https://arxiv.org/abs/2012.05031)

79. **Assessment Modeling: Fundamental Pre-training Tasks for Interactive Educational Systems**
...
80. **EKT: Exercise-Aware Knowledge Tracing for Student Performance Prediction**
...
83. :sparkles: **Math Multiple Choice Question Generation via Human-Large Language Model Collaboration**

    *Jaewook Lee, Digory Smith, Simon Woodhead, Andrew Lan*

    EDM, 2024. [`conference`](https://arxiv.org/abs/2405.00864)

84. :sparkles: **Improving Automated Distractor Generation for Math Multiple-choice Questions with Overgenerate-and-rank**
...
85. :sparkles: **Exploring Automated Distractor Generation for Math Multiple-choice Questions via Large Language Models**
...
86. :sparkles: **Multiple Choice Questions and Large Languages Models: A Case Study with Fictional Medical Data**

    *Maxime Griot, Jean Vanderdonckt, Demet Yuksel, Coralie Hemptinne*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2406.02394)

87. :sparkles: **Leveraging Large Language Models for Concept Graph Recovery and Question Answering in NLP Education**
...
88. **ReadingQizMaker: A Human-NLP Collaborative System that Supports Instructors to Design High-Qality Reading Qiz Qestions**
...
89. :sparkles: **Large Language Model Augmented Exercise Retrieval for Personalized Language Learning**
...
90. **Fine-Grained Similarity Measurement between Educational Videos and Exercises**
...
94. :sparkles: **Supporting Self-Reflection at Scale with Large Language Models: Insights from Randomized Field Experiments in Classrooms**
...
95. :sparkles: **The Promises and Pitfalls of Using Language Models to Measure Instruction Quality in Education**

    *Paiheng Xu, Jing Liu, Nathan Jones, Julie Cohen, Wei Ai*

    NAACL, 2024. [`conference`](https://arxiv.org/abs/2404.02444)

96. :sparkles: **MathVC: An LLM-Simulated Multi-Character Virtual Classroom for Mathematics Education**

    *Murong Yue, Wijdane Mifdal, Yixuan Zhang, Jennifer Suh, Ziyu Yao*

    arXiv, 2024. [`preprint`](https://arxiv.org/abs/2404.06711)

97. **The Knowledge-Learning-Instruction Framework: Bridging the Science-Practice Chasm to Enhance Robust Student Learning**
...
98. :sparkles: **Assisting in Writing Wikipedia-like Articles From Scratch with Large Language Models**
...
102. :sparkles: **Robosourcing Educational Resources – Leveraging Large Language Models for Learnersourcing**
...
112. **PTADisc: A Cross-Course Dataset Supporting Personalized Learning in Cold-Start Scenarios**
...
117. **EdNet: A Large-Scale Hierarchical Dataset in Education**
